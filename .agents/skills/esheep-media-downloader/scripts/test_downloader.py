...
def test_parse_info_json():
    sample_yt_dlp_json = json.dumps({
        ...
        "formats": [
            ...
            {"format_id": "4", "height": 720, "vcodec": "avc1"},  # duplicate height
            {"format_id": "5", "height": None, "vcodec": "none"},  # audio only
            {"format_id": "6", "height": 480, "vcodec": "none"},  # no video codec
        ]
    })
    
    # Test handling stdout with prefix text or multiline
